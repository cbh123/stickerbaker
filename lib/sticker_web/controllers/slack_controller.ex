defmodule StickerWeb.SlackController do
      ...
      "blocks" => [
        %{
          ...
          text: %{
            type: "mrkdwn",
            text:
              "AI #{text} by @#{params["user_name"]} and <https://replicate.com/fofr/sdxl-sticker|fofr/sdxl-sticker>"
          }
        },
        %{
          type: "image",
  ...
  defp gen_image(prompt) do
    styled_prompt =
      ...
      |> String.replace("sticker of a a ", "sticker of a ")
      |> String.replace("sticker of a an ", "sticker of an ")

    {:ok, deployment} = Replicate.Deployments.get("cbh123/sdxl-sticker")
